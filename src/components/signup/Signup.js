        ...
        <div className={styles.signup}>
            ...
            <div className={styles.signup__content}>
                ...
                <div className={styles.signup__center_content}>
                    <div className={styles.signup__text_content}> Make the most of your 
                    professional life</div>
                    <div className={styles.signup__box_content}>
                        <label className={styles.input__label} forhtml="email-or-phone">Email or 
                        phone number</label>
                        <input className={styles.input__input} required id="email-or-phone" 
                        type="text" name="email-or-phone"  value="" onChange={()=>{}}/>
                        
                        <label className={styles.input__label} forhtml="password">Password (6 or 
